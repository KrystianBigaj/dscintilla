...
Supported Delphi versions: D6-D2010+ (D6-D2007 requires JEDI-JCL dependency).
...
2. Put SciLexer.dll to path where Delphi will be able load it. It could be for example: C:\Program Files (x86)\CodeGear\RAD Studio\6.0\bin. Alternatively you could copy SciLexer.dll to for example C:\Windows\SysWOW64 (or if you are still using x86 then it will be C:\Windows\System32)
